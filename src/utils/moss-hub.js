...
const {
  ...
  VITE_HASHKEY_CONTRACT,
  VITE_HASHKEY_HELPER_CONTRACT,
} = import.meta.env;
...
const map2 = {
  ...
  HASHKEY: VITE_HASHKEY_HELPER_CONTRACT,
};
...
export class MossHub {
  constructor(chainId) {
    ...
    else if (chainId == VITE_HASHKEY_CHAINID) type = "HASHKEY";
